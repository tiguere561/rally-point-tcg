...
export default function AboutPage() {
  return (
    <>
      {/* Hero Section */}
      <div className="bg-dark-card border-b border-neon-cyan/20">
      ...
      <section className="container mx-auto px-4 py-16 md:py-20">
        <div className="max-w-3xl">
          <h2 className="text-3xl md:text-4xl font-bold text-white mb-6">
            The <span className="text-neon-purple">Rally Point</span> Story
          </h2>
      ...
      {/* Values Section */}
      <section className="bg-dark-card border-y border-neon-cyan/20 py-16 md:py-20">
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {/* Service */}
            <div className="bg-dark-bg border border-neon-cyan/20 rounded-lg p-8">
              <Target className="text-neon-cyan mb-4" size={40} />
            ...
            {/* Integrity */}
            <div className="bg-dark-bg border border-neon-cyan/20 rounded-lg p-8">
              <CheckCircle className="text-neon-purple mb-4" size={40} />
      ...
      <section className="container mx-auto px-4 py-16 md:py-20">
        <h2 className="text-3xl md:text-4xl font-bold text-white mb-12">
          Why <span className="text-neon-cyan">Rally Point</span>?
        </h2>
      ...
      <section className="relative bg-dark-card border-t border-neon-cyan/20">
        <div className="absolute inset-0 opacity-20">
          <div className="absolute top-1/2 left-1/2 w-96 h-96 bg-neon-cyan rounded-full mix-blend-multiply filter blur-3xl -translate-x-1/2 -translate-y-1/2" />
        </div>
        ...
        <div className="relative container mx-auto px-4 py-16 text-center">
          ...
          <Link href="/shop">
            <button className="inline-block px-8 py-4 bg-neon-cyan text-dark-bg font-bold rounded-lg hover:shadow-neon-cyan-lg transform hover:scale-105 transition-all">
              SHOP NOW
            </button>
          </Link>
        </div>
